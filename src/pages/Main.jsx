...
// import Header from "./components/Header";paramsparamsQuer
...
const Main = () => {
  ...
  useEffect(() => {
    if (aboutRef.current && searchParams.get("ScrollToAbout") === "") {
    ...
    <>
      <section className="model">
        <div className="container">
          <video src={Bashka} width="1920" height="710" autoPlay loop muted></video>
        </div>
      </section>
      <section className="environment">
        <div className="container">
          <h2 className="section-title environment__title">Environment</h2>
      ...
      <section className="arch">
        <div className="container">
          ...
          <div className="arch-item">
            ...
            <video src={Cafworking} width="1340" height="754" autoPlay loop muted></video>
          </div>
        </div>
        <div className="arch-item babel">
          ...
          <video src={Babel} width="1920" height="1080" autoPlay loop muted></video>
        </div>
        ...
        <div className="arch-item">
          ...
          <div>
            <video src={CubicMeter} width="1920" height="1080" autoPlay loop muted></video>
          </div>
        </div>
      </section>
      <section className="skills" id="skills" ref={aboutRef}>
        <div className="container">
